...
def merge_html_files(in_path, out_path, title):
    ...
    css_resource_path = pkg_resources.resource_filename(__name__, 'resources/style.css')
    ...
    js_resource_path = pkg_resources.resource_string(__name__, 'resources/report.js')
